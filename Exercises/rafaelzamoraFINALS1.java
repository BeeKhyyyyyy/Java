 ...
 */
public class rafaelzamoraFINALS1 {  // Library Management System class
    ...
    public static void displayMenu() {
        ...
        System.out.println("5. Display all books");        // Display all books
    ...
    public static void removeBook(Scanner in, ArrayList<Integer> bookID, 
        ...
        if (index!=-1) {  // If the book is found, the book will be removed
        ...
        } else {  // If the book is not found, the user will be informed
    ...
    public static void updateBook(Scanner in, ArrayList<Integer> bookID, 
        ...
        if (index!=-1) {  // If the book is found, update:
            ...
            switch (option) {
                ...
                case 'A':
                    ...
                    if (bookID.contains(id)) {  // If the ID already exists, display:
                        System.out.println("*********** Book ID already exists! **********");
                    } else if (id<1) {  // If the ID is 0 or a negative number, display:
                        System.out.println("***** Book ID must be a positive number! *****");
                ...
                case 'B':
                    ...
                    /* If the Title does not yet exist, it will be modified */
                ...
                case 'E':
                    ...
                    if (yr<1) {  // If the Year is 0 or a negative number, display:
                        System.out.println("****** Year must be a positive number! *******");
